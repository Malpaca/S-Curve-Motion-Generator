...
{
    switch (mode) {
    case SCURVE_LINEAR: return 1.0f;
    case SCURVE_CUBIC_SMOOTHSTEP: return 1.5f;
    case SCURVE_QUINTIC_SMOOTHERSTEP: return 1.875f;
    default: return 1.0f;
    }
}
...
{
    switch (mode) {
    case SCURVE_LINEAR: return 0.0f;
    case SCURVE_CUBIC_SMOOTHSTEP: return 6.0f;
    case SCURVE_QUINTIC_SMOOTHERSTEP: return 5.77350269f;
    default: return 0.0f;
    }
}
...
float scurve_peak_jerk_norm(scurve_mode_t mode)
{
    switch (mode) {
    case SCURVE_LINEAR: return 0.0f;
    case SCURVE_CUBIC_SMOOTHSTEP: return 12.0f;
    case SCURVE_QUINTIC_SMOOTHERSTEP: return 60.0f;
    default: return 0.0f;
    }
}
